...
function DashboardAuction() {
    ...
    return (
        <div className=''>
            <Toast ref={toast} />
            <div className='mt-5'>
                <h1 className='text-2xl font-bold text-center text-slate-800'>Subastas disponibles actualmente</h1>
            </div>
                    ...
                    auctions.length > 0 ?
                        auctions.map((auction, index) => (
                            <div key={index} className='flex flex-col md:flex-row gap-2'>
                                <div className='md:w-3/4 bg-slate-300 rounded-2xl text-left p-3'>
                                    ...
                                    <p className='text-xl font-bold text-slate-800'>
                                        Estado:
                                        <span className='font-normal mx-1 px-2 pb-1 bg-green-500 rounded-md'>
                                            Activa
                                        </span>
                                    </p>
                                </div>
                                <div className='flex flex-auto items-center justify-center'>
                                    <button
                                        className='px-4 py-2 text-white bg-slate-800 font-bold rounded-lg 
                                    hover:bg-slate-900'
                                        onClick={() => { openModalOffer(auction) }}
                                    >
                                        Ofertar
                                    </button>
                                </div>
